package com.example.rober.navigationdrawerroberto;
...
public class MainActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem menuItem) {
        ...
        switch (id) {
            case R.id.conta:
                Toast.makeText(MainActivity.this, "Contas", Toast.LENGTH_SHORT).show();
                break;
            case R.id.config:
            ...
            case R.id.carrinho:
                ...
                break;
            case R.id.listanotas:
                Toast.makeText(MainActivity.this, "Listagem de Alunos", Toast.LENGTH_SHORT).show();
